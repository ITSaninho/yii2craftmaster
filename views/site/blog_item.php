...
<div class="breadcrumbs">
    <div class="container">
        <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__list-item"><a href="#">Блог</a></li>
            <li class="breadcrumbs__list-item breadcrumbs__list-item--active"><a href="#">Почему интернет-магазины такие неудобниые</a></li>
        </ul>
    </div>
</div>

<article class="blog-item">
    <h3 class="section-title blog-title">Почему интернет-магазины такие неудобниые</h3>
    <div class="container">
        <div class="blog-item__article-img">
            <img src="img/blog_item.jpg" width="1140" height="500" alt="">
        </div>
        <div class="blog-item__article-info">
			<span class="blog-item__tag">
				<a class="blog-tags__link blog-tags__link--active" href="#">web</a>
			</span>
			<span class="blog-item__article-date">
				<object data="img/date.svg" type="image/svg+xml"></object>
				24.05.2017
			</span>
			<span class="blog-item__article-veis">
				<object data="img/veiws.svg" type="image/svg+xml"></object>
				353
			</span>
			<span class="blog-item__article-commnet">
				<object data="img/comment.svg" type="image/svg+xml"></object>
				433
			</span>
        </div>
        <div class="blog-item__article-descr">
            <p class="blog-item__article-text">
                Нередко во время покупок в интернет-магазинах напрашивается вывод, что на проработку дизайна их владельцы не пожалели денег, но почему-то сайт всё равно сделан небрежно. Специалисты Craft Development сегодня расскажут, почему интернет-магазины такие неудобные.

                Кратко о недостатках:

                • Мобильная версия не для всех.

                • Непродуманная работа фильтров

                • Не работает сортировка.

                • На главной странице откровенный мусор.

                • Сложная навигация.

                А теперь рассмотрим эти недостатки более подробно.

                Проблема 1. Мобильная версия не для всех

                Большинство магазинов показывают удобную версию на телефоне, напрочь забывая о планшетах. Вероятно, причина в том, что хотя сейчас больше трети пользователей сидит в Интернете с мобильных устройств, доля планшетов среди них не так уж высока. Экраны таких гаджетов недостаточно большие для попадания пальцем по ссылкам в десктопной версии сайта. Одновременно телефонные версии сайтов кажутся излишне упрощенными из-за чрезмерно крупного шрифта.

                Два решения проблемы: можно показывать для планшетов телефонную версию или сделать сайт адаптивным.

                Проблема 2. Непродуманная работа фильтров

                Во многих интернет-магазинах есть странные недоработки, которые усугубляются при работе с планшетов:

                1. Проблема ввода в текстовые поля. При попытке в фильтре максимальной цены ввести определенную сумму сложно удалить изначальные цифры. Для этого понадобиться определенная ловкость: выделяем весь текст и на клавиатуре набираем цифры.

                2. Вторая проблема связана со слайдерами. Зачастую с помощью слайдера невозможно поставить адекватную максимальную цену. Если в каталоге присутствует хотя бы один дорогой товар - слайдер становится бесполезным.

                Проблема 3. Сортировка работает некорректно

                Сортировка выдает в качестве самого дорогого товара не соответствующий этой характеристике. Прокрутив колесико мыши, можно найти по-настоящему самый дорогой товар, который должен быть первым в списке. То же самое, если искать самый дешёвый товар.

                Проблема 4. Неэффективная главная страница

                На главной странице интернет-магазина должен быть товар, который необходимо продать в первую очередь. О дешевых фото со стока лучше отказаться. Надписи должны быть упрощенными. Требования регистрации неуместны, так как это можно сделать перед оплатой.

                Проблема 5. Запутанная навигация

                Это проблема многих запутанных сайтов, на которых чтобы посмотреть нужный товар, требуется пройти целый квест. Непонятно, зачем настолько усложнять доступ к каталогу?

                По мнению специалистов Craft Development интернет-магазин должен быть создан с душой, с пониманием того, что покупателю должно быть удобно. Именно тогда у клиента будет желание в день зарплаты зайти на этот сайт и поинтересоваться новинками.
...
<div class="blog-additional">
    <div class="container">
        <b class="blog-additional__title">Читайте также:</b>

        <div class="blog-additional__wrap">
            <div class="blog-additional__item">
                <img width="365" height="365" src="img/blog_item.jpg" alt="">
                <strong class="blog-additional__item-title">5 вопросов, которые заказчик должен задать веб-дизайнеру</strong>
                <a href="" class="blog-additional__item-subtitle">Читать далее</a>
            </div>
            <div class="blog-additional__item">
                <img width="365" height="365" src="img/blog_add_img.jpg" alt="">
                <strong class="blog-additional__item-title">5 вопросов, которые задать веб-дизайнеру</strong>
                <a href="" class="blog-additional__item-subtitle">Читать далее</a>
            </div>
            <div class="blog-additional__item">
                <img width="365" height="365" src="img/blog_add_img.jpg" alt="">
...
<div class="blog-item-comment">
    <div class="container">
        <b class="blog-item-comment__title">Оставить коментарий</b>
        <div class="blog-item-comment__wrap">
            <form action="#" method="post" class="blog-item-comment__form">
                <div class="blog-item-comment__input-wrap">
                    <input name="comment-user-name" type="text" placeholder="Имя">
                    <input name="comment-user-mail" type="mail" placeholder="E-mail">
                </div>
                <textarea name="" id="" cols="30" rows="10" placeholder="Текст сообщения"></textarea>
                <button class="btn btn--comment"  type="submit"><span>Написать</span></button>
            </form>
        </div>
    </div>
</div>
