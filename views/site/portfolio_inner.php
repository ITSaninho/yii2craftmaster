...
<section class="portfolio">
    <div class="container-fluid">
        ...
        <div class="services-tags">
            <a class="services-tags__active" href="#">лендинг page</a>
            <a href="#">корпоративный сайт</a>
            <a href="#">интернет-мфгазин</a>
            <a href="#">интерактивный сервис</a>
            <a href="#">дизайн</a>
            <a href="#">индивидуальное решение</a>
        </div>
        <div class="portfolio__inner">
            <ul class="portfolio__list">
                <li class="portfolio__item">
                    <a href="portfolio__item.html" target="_blank">
                ...
                <li class="portfolio__link">
                    <a class="btn btn--link btn--portfolio" href="#">
                        показать еще
                    </a>
                </li>
            </ul>
