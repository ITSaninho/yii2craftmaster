...
<section class="portfolio-item">
    <h3 class="section-title portfolio-title portfolio-title--inner">Fixitmobile.ru</h3>
    <div class="container">
        <div class="portfolio-item__descr">
            <b class="portfolio-item__descr-title">Описание проекта:</b>
            <p class="portfolio-item__descr-text">Лендинг страница для сервиса, который специализируется на выездном ремонте гаджетов Apple любой сложности и в любой точке Москвы.
            </p>
            <b class="portfolio-item__descr-title">Задача:</b>
            <p class="portfolio-item__descr-text">Разработать дизайн лендинг страницы, на которой требуется показать, что данный сервис является честным, надежным, качественным и быстрым. Показать цены на услуги, описать порядок сотрудничества, добавить возможность обратной связи и заказа прямо с сайта посредством форм или звонка.
            </p>
            <b class="portfolio-item__descr-title">Что следано:</b>
            <p class="portfolio-item__descr-text">
                На основе анализа рынка и предоставленного конента были выявлены сильные стороны ресурса и сделан прототип. На основе прототипа был разработан уникальный дизайн, который являет собой интуитивно понятный и простой интерфейс с последовательно выложенной информацией про ресурс.
            </p>
            <a href="" class="btn btn--portfolio-item"><span>Перейти на сайт</span></a>

        </div>
        <div class="portfolio-item__img">
            <img src="img/imac_img.jpg" width="512" height="291"  alt="">
        </div>
    </div>
...
<div class="learn-more">
    <div class="container">
        <b class="learn-more__title">Узнайте больше о наших веб-услугах</b>
        <button type="button" class="btn btn--learn-more"><span>Задать вопрос</span></button>
        <a class="learn-more__link" href="#">Назад в портфолио</a>
    </div>
</div>
