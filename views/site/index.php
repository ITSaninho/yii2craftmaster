        ...
        <article class="blog__article">
            <div class="blog__article-img">
                <a href="blog_item.html">
                    <img src="/web/img/img.jpg" width="270" height="288" alt="">
                </a>
            </div>
                ...
                <div class="blog__item-inner">
                    ...
                    <div class="blog__article-info">
                           <span class="blog__article-date">
                              <object data="/web/img/date.svg" type="image/svg+xml"></object>
                              24.05.2017
                          </span>
                          <span class="blog__article-veis">
                           <object data="/web/img/veiws.svg" type="image/svg+xml"></object>
                           35
                       </span>
                       <span class="blog__article-commnet">
                           <object data="/web/img/comment.svg" type="image/svg+xml"></object>
                           1
                       </span>
                    </div>
                </div>
...
<section class="choose-us">
    ...
    <div class="container">
        ...
        <div class="choose-us__img">
            <object data="/web/img/craft-logo.svg" type="image/svg+xml"></object>
        </div>
    </div>
</section>
...
<footer class="main-footer">
    ...
    <div class="container">
        ...
        <div class="footer-logo">
            <object data="/web/img/craft-logo-footer.svg" type="image/svg+xml"></object>
        </div>
    </div>
