...
class TeamController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if(!empty($model->image = UploadedFile::getInstance($model, 'image'))){
                $model->image->saveAs('../web/data/team/images/' . $model->image->baseName . '.' . $model->image->extension);
                $model->image = $model->image->baseName . '.' . $model->image->extension;
            }else{
                $model->image = 'no_photo.jpg';
            }
